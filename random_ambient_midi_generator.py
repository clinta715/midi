...
def generate_chords(key='C', mode='major', num_chords=8, bpm=60):
    ...
    if num_chords == 'random':
        num_chords = random.randint(4, 12)
    if bpm == 'random':
...
if __name__ == "__main__":
    ...
    parser.add_argument('--key', type=str, default='C', help='Key of the sequence (default: C or random)')
    parser.add_argument('--mode', type=str, default='major', choices=['major', 'minor', 'lydian', 'mixolydian', 'random'], help='Scale mode (default: major or random)')
    parser.add_argument('--num_chords', type=str, default='8', help='Number of chords to generate (default: 8 or random)')
    parser.add_argument('--bpm', type=str, default='60', help='Tempo in BPM (default: 60 or random)')
